...
namespace FGLSL {
    ...
    FGLSLShader Preprare(std::filesystem::path entry, PreprocessFlags flags = PreprocessFlags::NONE) {
            ...
            for (auto &s : shaders) {
                ...
                for (auto c : s.settings) {
                    ...
                    for (auto setting : settings) {
                        if (c.name == setting.name && c.value == setting.value) {
                            found = true;
                            break;
                        }
                    }
                ...
                if (foundS) {
                    ...
                    for (auto c : s.conditions) {
                        for (auto setting : conditional_settings) {
                            if (c.name == setting.name && c.active == setting.active) {
                                found = true;
                                break;
                            }
                        }
    ...
    GLSLShaders GenerateShaders(FGLSLShader sh) {
