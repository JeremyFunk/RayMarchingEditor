...
namespace RayMarcher.Util
{
    ...
    static class MathsMatrix
    {
        ...
        public static Matrix3 CreateTransformationMatrix3(Vector3 rotation, Vector3 scale)
        {
            ...
            matrix *= Matrix3.CreateRotationX((float)MathsUtil.DegreeToRadian(rotation.X));
            matrix *= Matrix3.CreateRotationY((float)MathsUtil.DegreeToRadian(rotation.Y));
            matrix *= Matrix3.CreateRotationZ((float)MathsUtil.DegreeToRadian(rotation.Z));
        ...
        public static Matrix4 CreateTransformationMatrix(Vector3 translation, float rx, float ry, float rz, float scale)
        {
            ...
            matrix *= Matrix4.CreateRotationX((float)MathsUtil.DegreeToRadian(rx));
            matrix *= Matrix4.CreateRotationY((float)MathsUtil.DegreeToRadian(ry));
            matrix *= Matrix4.CreateRotationZ((float)MathsUtil.DegreeToRadian(rz));
        ...
        {
            Matrix4 matrix = Matrix4.Identity;
            matrix *= Matrix4.CreateRotationX((float)MathsUtil.DegreeToRadian(rotation.X));
            matrix *= Matrix4.CreateRotationY((float)MathsUtil.DegreeToRadian(rotation.Y));
            matrix *= Matrix4.CreateRotationZ((float)MathsUtil.DegreeToRadian(rotation.Z));
            matrix *= Matrix4.CreateScale(scale);
            matrix *= Matrix4.CreateTranslation(translation);
        ...
        public static Matrix4 CreateViewMatrix(Vector3 cameraPos, float pitch, float yaw, float roll)
        {
            ...
            orientation *= Matrix4.CreateRotationY((float)MathsUtil.DegreeToRadian(yaw));
            orientation *= Matrix4.CreateRotationX((float)MathsUtil.DegreeToRadian(-pitch));
