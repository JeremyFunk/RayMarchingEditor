...
namespace RayMarcher.RayMarcher.Renderer
{
    abstract class ShaderProgram
    {
        ...
        public ShaderProgram(string vertexShaderPath, string fragmentShaderPath)
        {
            ...
            vertexShaderID = CreateShader(Util.Loader.ReadFile(vertexShaderPath), ShaderType.VertexShader);
            fragmentShaderID = CreateShader(Util.Loader.ReadFile(fragmentShaderPath), ShaderType.FragmentShader);
