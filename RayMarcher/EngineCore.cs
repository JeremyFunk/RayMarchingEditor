...
using OpenTK.Input;
using RayMarcher.Util;
using RayMarcher.RayMarcher.Renderer;
using RayMarcher.RayMarcher.Primitives;
using RayMarcher.RayMarcher;
...
namespace RayMarcher
{
    class EngineCore : GameWindow
    {
        ...
        private MandelbulbPrimitive mandel;
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            //primitives.Add(new CubePrimitive(1.0f, 1.0f, 1.0f, new Vector3(0, 0, 0), new Vector3(0, 45, 0), new Vector3(1)));
            mandel = new MandelbulbPrimitive(0.0f, new Vector3(0), new Vector3(0), new Vector3(1));
            primitives.Add(mandel);
        ...
        protected override void OnUpdateFrame(FrameEventArgs e)
        {
            ...
            if(GameInput.IsKeyDown(Key.P))
                mandel.power += (float)e.Time;
            Matrix3 mat = MathsMatrix.CreateRotationMatrix3(rotation);
            fractalRenderer.GetShader().UpdateCamera(position, mat.Inverted());
            GameInput.Update();
        }
